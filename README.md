...
- **Site público (`/`)** — a página vista pelo cliente: hero editorial, menu de serviços com preços, fotos e o **painel de agendamento online** — o cliente escolhe serviço, dia e um dos horários livres (a API só oferece slots dentro do funcionamento) e confirma; a solicitação cai direto na agenda interna e dispara o e-mail de confirmação via n8n. O rodapé leva à Área do funcionário.
